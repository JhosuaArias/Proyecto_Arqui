...
//            }
    ...
    private void lw_resolverFalloCacheDatos(Hilo hiloEjecucion, int numRegistro, int direccionMemoria, TipoDeFallo tipo){
        ...
        switch (tipo)
        {
            case LW_NOESMIETIEQUETAYMODIFICADO:
                ...
                simulacion.setEstadoN0(direccionMemoria,INVALIDO);
            ...
            case LW_CARGARDESDECACHE:
                ...
                simulacion.setEstadoN1(direccionMemoria,COMPARTIDO);
    ...
    public void lw(Hilo hiloEjecucion, int numRegistro, int direccionMemoria){
        ...
        while (noTermine)
        {
            ...
            else //Logre bloquear el indice, sigo
            {
                ...
                {
                    if(bloqueCacheDatos.getEstado()== INVALIDO)  //La etiqueta esta invalida
                    {
                        if (!simulacion.intentar_pedirBusDatos_Memoria()) //No pude bloquear el bus
                        {
                            simulacion.desbloquear_Posicion_CacheDatosN0(posicion);
    ...
    public  void lw_VerificarSiEstaEnN1(Hilo hiloEjecucion,int numRegistro,int direccionMemoria)
    {
    ...
    public void cargarPalabraN0(Hilo hiloEjecucion, int numRegistro, int direccionMemoria)
    {
    ...
    public  void sw_VerificarSiEstaEnN1(Hilo hiloEjecucion,int numRegistro,int direccionMemoria)
    {
        /*vengo de bloquear el indice del otro cache*/
    ...
    public void sw_estoyEnCompartidoN0(Hilo hiloEjecucion, int numRegistro, int direccionMemoria)
    {
        /*vengo de bloquear el indice del otro cache*/
    ...
    public void guardarPalabraN0(Hilo hiloEjecucion,int numRegistro,int direccionMemoria)
    {
        ...
        simulacion.setPalabraCacheDatosN0(numRegistro,numeroPalabra,direccionMemoria);

        /*Lo pongo en modificado*/
        simulacion.setEstadoN0(direccionMemoria,Estado.MODIFICADO);
